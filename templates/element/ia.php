    ...
    <div class="chatbot-container">
        <div class="chatbot-header">
            <div class="chatbot-data">
                ...
                <span class="name">Leitlearn AI</span>
                <sup><span>beta</span></sup>
            </div>
            <div class="ia-actions">
                <div class="report ia-action" id="ia-report">
                    <span class="material-symbols-rounded">
                        flag
                    </span>
                </div>
                <div class="hide ia-action" id="ia-hide">
                    <span class="material-symbols-rounded">
                        expand_more
                    </span>
                </div>
        ...
        <div class="chatbot-form">
            <div class="input-group" id="ai-input-group">
                <input type="text" name="ai-request" id="ai-request" placeholder="Sujet">
                <select name="ai-number-requested" id="ai-number-requested">
            ...
            <input type="submit" id="ai-request-submit" value="Générer mes flashcards">
            <input type="submit" id="ai-create-submit" value="Créer ce paquet">
            <small class="prevent">Leitlearn AI v0.3 · Leitlearn AI peut faire des erreurs.</small>
        </div>
    </div>
